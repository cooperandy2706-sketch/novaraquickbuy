    ...
    <div className="min-h-screen bg-surface selection:bg-brand/10 selection:text-brand">
      ...
      <section className="py-32 text-center page">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <Link href="/feed" className="px-12 py-6 bg-white text-neutral-900 border border-neutral-200 rounded-[2.5rem] font-black uppercase tracking-widest hover:bg-neutral-50 active:scale-95 transition-all">
            Browse the Market
          </Link>
        </div>
      </section>
